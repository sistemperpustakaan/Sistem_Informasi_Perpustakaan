            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>Nomor Peminjam</th><th>Nama Peminjam</th><th>Tanggal Pinjam</th><th>Tanggal Kembali</th><th>Lama Pinjaman</th><th>ACTIONS</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['tgl_kembali'] ?> &nbsp 
                                        <a href="?page=peminjaman&actions=kembaliArsip&nope=<?= $data['no_peminjam'] ?>" class="btn btn-info btn-xs "> <span class="fa fa-forward"></span></a>
									</td>
